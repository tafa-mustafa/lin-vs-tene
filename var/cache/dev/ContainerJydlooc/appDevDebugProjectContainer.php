...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('xmbOR-jIHZ', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7VgPvjB3+d', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xvs-nroaMy', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9d1wdOrLTt', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1c5278a26c5d820fdb5853a81e01538ca641da90')) && false ?: '_'}, '/_fragment');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/biblioBundle/Resources/views'), 'biblio');
        $instance->addPath(($this->targetDirs[3].'/src/biblioBundle/Resources/views'), '!biblio');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1c5278a26c5d820fdb5853a81e01538ca641da90');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'biblioBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/biblioBundle'),
                    'namespace' => 'biblioBundle',
                ),
                'FOSUserBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'biblioBundle' => 'biblioBundle\\biblioBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'MA_COMMUNE',
            'database_user' => 'root',
            'database_password' => 'tafatene10',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'tenetafa@gmail.com',
            'mailer_password' => 'halawi10',
            'secret' => '1c5278a26c5d820fdb5853a81e01538ca641da90',
            'locale' => 'fr',
            'fragment.renderer.hinclude.global_template' => '',
            'fragment.path' => '/_fragment',
            'kernel.secret' => '1c5278a26c5d820fdb5853a81e01538ca641da90',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'tenetafa@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'halawi10',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'tenetafa@gmail.com' => 'tenetafa@gmail.com',
            ),
