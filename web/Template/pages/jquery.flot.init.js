...
! function($) {
	...
	FlotChart.prototype.init = function() {
		...
		var datas = [20, 30, 15];
		var colors = ["#7e57c2", "#00b19d", "#ebeff2"];
		this.createPieGraph("#pie-chart #pie-chart-container", pielabels, datas, colors);

		//real time data representation
		var plot = this.createRealTimeGraph('#flotRealTime', this.randomData(), ['#7e57c2']);
		plot.draw();
		var $this = this;
		function updatePlot() {
		...
		var donutcolors = ["#7e57c2", "#00b19d", "#ebeff2", "#dcdcdc"];
